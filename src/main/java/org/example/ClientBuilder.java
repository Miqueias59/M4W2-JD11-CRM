...
public class ClientBuilder {
    ...
    public ClientBuilder comIdentificacao(String primeiroNome, String nomesDoMeio, String sobrenome, String cpf,
    ...
    public ClientBuilder comContatos(String email, String endereco, String telefone) {
        this.email = email;
    ...
    public void setEmail(String email) throws RuntimeException {
        if (email.matches(EMAIL_REGEX)) {
            ...
            throw new RuntimeException("Digite um e-mail em um modelo válido");
        }
    }
